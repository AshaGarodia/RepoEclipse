...
public class GooglePageSpeedScoresForMultipleURLs {
...
driver.manage().timeouts().implicitlyWait(10,TimeUnit.SECONDS);
 ...
 //Clicking the mobile button
  //driver.findElement(By.xpath("//button[@id='mobile_tab']")).click();
                    ...
                    if(performance== null || !performance.isDisplayed()){
                    	System.out.println("Error");
                    	continue;
                    }
                                     
                    if(accessibility == null || !accessibility.isDisplayed()) {
                    	System.out.println("Error");
                    	continue;
                    }
                    
                    if(bestpractices == null || !bestpractices.isDisplayed()) {
                    	System.out.println("Error");
                    	continue;
                    }
                    if(seo == null || !seo.isDisplayed()) {
                    	System.out.println("Error");
                    	continue;
                    }
                ...
                //  Thread.sleep(2000);
                 ...
                 // Write the scores back to the Excel sheet
                  ...
                  if(dPerformance == null || !dPerformance.isDisplayed()) {
                    System.out.println("Error");
                  	continue;
                  }
                  
                  if(dAccessibility == null || !dAccessibility.isDisplayed()) {
                    	System.out.println("Error");
                    	continue;
                    }
                    
                  if(dBestPractices == null || !dBestPractices.isDisplayed()) {
                  	System.out.println("Error");
                  	continue;
                  }
                  
                  if(dSeo == null || !dSeo.isDisplayed()) {
                    	System.out.println("Error");
                    	continue;
                    }
